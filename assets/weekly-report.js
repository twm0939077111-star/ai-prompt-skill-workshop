(() => {
  ...
  const pages=[
    {id:'local_weekly_setup',title:'先準備好：下載與安裝週報 Skill',tag:'週報實作 ①｜下載與準備',lead:'繁體中文教學版：weekly-report-zh-tw。先下載，再確認技能選單。',body:grid(card('01 下載教學包','<a href="assets/downloads/weekly-report-teaching.zip" download="weekly-report-teaching.zip">下載 Skill＋練習資料 ↗</a>'),card('02 安裝到 Codex','解壓後，把技能資料夾放進<br>課堂專案的 .agents/skills/。'),card('03 確認可以選用','開啟新對話，輸入 $ 選取<br>weekly-report-zh-tw。'),card('04 這次只需文字','不需外部帳號或 API 金鑰；<br>AI 執行仍使用平台額度。')),note:'ChatGPT 網頁版須有可用的技能／外掛入口；下載資料夾不等於完成網頁安裝。'},
